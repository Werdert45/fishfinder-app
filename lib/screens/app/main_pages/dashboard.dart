...
import 'package:fishfinder_app/shared/updatesFunction.dart';
          ...
          child: SingleChildScrollView(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                var completeUser = CompleteUser(uid: u['uid'], name: u['name'], email: u['email'], updates: u['updates'], friend_request: u['friend_request'], friends: u['friends']);
